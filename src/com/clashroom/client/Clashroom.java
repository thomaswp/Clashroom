 ...
 */
public class Clashroom implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		canvas.getContext2d().setFillStyle("#ff00ff");
		canvas.getContext2d().fillRect(0, 0, 200, 200);
		canvas.getContext2d().setFillStyle("#000000");
		canvas.addClickHandler(new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				canvas.getContext2d().arc(event.getX(), event.getY(), 5, 0, 2 * Math.PI);
				canvas.getContext2d().closePath();
				canvas.getContext2d().fill();
			}
		});
		//canvas.getContext2d().arc(50, 50, 5, 0, 2 * Math.PI);
